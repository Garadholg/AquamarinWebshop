        ...
        <div id="contentContainer" class="container">
            ...
            <div class="tableContainer">
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach var="item" items="${requestScope.cartProducts}">
                            <tr>
                                <td>
                                    <img class="tdItemImage" src="/Aquamarin-Webshop/static/resources/images/products/${item.product.primaryImage.path}" alt="${item.product.productName}-image">
                ...
                <div class="cartActionContainer">
                    ...
                    <button class="btnBuy">Kupi</button>
                </div>
            </div>
