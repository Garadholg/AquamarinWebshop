...
<html>
    <head>
        ...
        <title>Aquamarin | Podaci o kupovini</title>
        
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
        <link rel="stylesheet" href="/Aquamarin-Webshop/static/styles/navbar.css" type="text/css">
        <link rel="stylesheet" href="/Aquamarin-Webshop/static/styles/checkout.css" type="text/css">

        <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
        <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous"></script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
        <script src="https://www.paypal.com/sdk/js?currency=EUR&client-id=Aa3eAhJp72m6002I4fU3iYybizzBYLiKInwOqFDU1tUEDbV2iq2dngCJPLBg07KwaAVmCWr8bZ5eofCE"></script>
        <script src="/Aquamarin-Webshop/static/scripts/checkout.js"></script>
    </head>
    <body>
        ...
        <div id="contentContainer" class="container">
            ...
            <div id="buyerSection" class="sectionContent sectionOpen">
                ...
                <div class="sectionForm">
                    <form id="buyerDataForm" action="/Aquamarin-Webshop/checkout?data=buyer" method="POST">
                        <div class="form-row">
            ...
            <div id="paymentSection" class="sectionContent sectionDisabled">
                ...
                <div class="sectionForm">
                    <form id="paymentForm" action="/Aquamarin-Webshop/checkout?data=payment" method="POST">
                        <div class="form-group">
